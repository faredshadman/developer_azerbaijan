...
const Header = () => {
  ...
  return (
    <div className="h-14 shadow-md">
      <header className="fixed z-[50] flex h-14 max-w-6xl mx-auto inset-x-0 items-center justify-between px-4 top-0 ">
        <Link href="/">
          <a>
        ...
        <div className="text-black hidden lg:inline-flex overflow-hidden space-x-2 relative">
          ...
          />
          <select name="langs" className="bg-transparent border-0 outline-none">
            {langs.map((lang) => (
